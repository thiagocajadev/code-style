...
Padrões de performance SQL: [sql/conventions/advanced/performance.md](../../../sql/conventions/advanced/performance.md).
...
Ao receber relatório de "banco NoSQL lento":
