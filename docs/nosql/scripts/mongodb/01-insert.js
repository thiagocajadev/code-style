...
const insertedCount = await createPlayers([
  { teamId, name: 'Jonathan Calleri', position: 'Forward', squadNumber: 9, nationality: 'Argentine' },
  { teamId, name: 'Rafinha', position: 'Right Back', squadNumber: 2, nationality: 'Brazilian' },
  { teamId, name: 'Arboleda', position: 'Centre Back', squadNumber: 5, nationality: 'Ecuadorian' },
]);
