...
Listas seguem a regra de [`null-safety`](null-safety.md): nunca `nil`, sempre `[]`. Ausência e vazio são equivalentes para quem itera.
...
- [`../advanced/null-safety.md`](null-safety.md): null-safety idiomático Ruby
